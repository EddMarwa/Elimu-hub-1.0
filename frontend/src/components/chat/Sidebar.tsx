...
export default function Sidebar({
  ...
  return (
    <div className="w-full h-full bg-white border-r border-gray-200 flex flex-col">
      {/* Header - more compact when collapsed */}
      ...
      {/* Document Upload Section - adaptive height */}
      <div className="p-4 border-b border-gray-200 flex-shrink-0">
        ...
        {/* Current Session Documents - improved display */}
        {currentSessionDocuments.length > 0 && (
          <div className="mt-3">
            <p className="text-xs text-gray-600 mb-2">
              Documents in this chat ({currentSessionDocuments.length}):
            </p>
      ...
      {/* Chat History - adaptive scrolling area */}
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <h4 className="text-sm font-medium text-gray-900 truncate flex-1">{chat.title}</h4>
                          {index === 0 && (
